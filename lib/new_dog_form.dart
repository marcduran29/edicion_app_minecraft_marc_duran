  ...
  void submitPup(BuildContext context) {
    if (nameController.text.isEmpty) {
      Scaffold.of(context).showSnackBar(new SnackBar(
        ...
        content: new Text('You must fill in the fields'),
      ));
    } else {
          ...
          child: new Column(children: [
            new Padding(
              ...
              child: new TextField(
                ...
                decoration: new InputDecoration(labelText: 'Mob name'),
              ),
            ),
            new Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              child: new TextField(
                ...
                decoration: new InputDecoration(labelText: "Health"),
              ),
            ),
            new Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
